...
const Footer = () => {
    return (
        <footer className="w-full bg-[#0D0D12] text-[#FAF8F5] pt-24 pb-8 px-6 md:px-16 rounded-t-[4rem] relative overflow-hidden mt-[-2rem] z-20 shadow-[0_-20px_40px_rgba(0,0,0,0.1)]">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12 mb-24">
                ...
                <div className="flex gap-16 md:gap-24 flex-wrap">
                    <div className="flex flex-col gap-4">
                        <h4 className="text-xs font-mono tracking-widest text-[#C9A84C] uppercase mb-2">Navigazione</h4>
                    ...
                    <div className="flex flex-col gap-4">
                        <h4 className="text-xs font-mono tracking-widest text-[#C9A84C] uppercase mb-2">Servizi</h4>
                    ...
                    <div className="flex flex-col gap-4">
                        <h4 className="text-xs font-mono tracking-widest text-[#C9A84C] uppercase mb-2">Legale</h4>
            ...
            <div className="max-w-7xl mx-auto border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p className="text-gray-500 text-xs flex items-center gap-2">
                    Designed with <span className="text-[#C9A84C]">✦</span>
                </p>
            </div>
        </footer>
    );
